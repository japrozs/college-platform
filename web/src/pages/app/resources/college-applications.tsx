...
import {
    COLLEGE_APPLICATION_RESOURCES,
    FINANCIAL_AID_RESOURCES,
} from "@/constants";
                ...
                <div className="px-10 py-5">
                    <div className="flex items-center mb-3">
                        <p className="text-3xl global_title">
                            ...
                            {COLLEGE_APPLICATION_RESOURCES.name} Resources
                        </p>
                        <div
                    ...
                    <p className="text-gray-600 mb-10">
                        {COLLEGE_APPLICATION_RESOURCES.description}
                    </p>
                    {COLLEGE_APPLICATION_RESOURCES.links.map(

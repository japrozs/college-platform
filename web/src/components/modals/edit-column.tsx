...
export const EditColumn: React.FC<EditColumnProps> = ({
    ...
    const changeName = () => {
        // created a clone and not just editetd the main struct
        // to keep the order of the tables intact
        // sure there's an easier way to do this but... who has the time?
        const boardCopy = structuredClone(board);
        boardCopy[id].name = name;
                        ...
                        >
                            ...
                            <div className="py-3 px-4">
                                ...
                                <button
                                    ...
                                    onClick={changeName}
                                    className={
                                        "ml-auto bg-blue-600 mt-4 text-sm mr-1 rounded-md py-1.5 text-gray-100 font-medium hover:opacity-95 transition duration-75"
                                    }
                                >
                                    Update
                                </button>
